...
\printglossary[title=Important Dates, toctitle=List of Dates, type=date, style=list]
\onecolumn
\printglossary[title=Notable Persons, toctitle=List of Persons, type=person, style=listhypergroup]
\twocolumn
\printindex
\end{document}
