...
\usepackage[left=.7in, top=1in, right=.7in, bottom=1in]{geometry}\usepackage{anyfontsize}
\usepackage{booktabs}
\usepackage{color}
\usepackage{hyphenat}
\usepackage{mathptmx}
...
\twocolumn
\printglossary[title=Special Terms, toctitle=List of Terms, type=default,style=list]
\printglossary[title=Important Dates, toctitle=List of Important Dates, type=date, style=listhypergroup]
\onecolumn
\printglossary[title=Notable Persons, toctitle=List of Notable Persons, type=person, style=listhypergroup]
\twocolumn
\printindex
\end{document}
